...
void lv_demo_widgets(void)
{
    ...
    if(disp_size == DISP_LARGE) {
        ...
        lv_label_set_text(lFabel, "LVGL v8");
    ...
    lv_obj_t * t1 = lv_tabview_add_tab(tv, "Temperatura");
    // lv_obj_t * t2 = lv_tabview_add_tab(tv, "Humedad");
    // lv_obj_t * t3 = lv_tabview_add_tab(tv, "Ventilador");
    profile_create(t1);
    // analytics_create(t2);
    // shop_create(t3);
